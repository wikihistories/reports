...
1. A person's 'description' may mention their indigeneity. For example, [Bennelong](https://www.wikidata.org/w/index.php?title=Q817828&oldid=1617736683) is described as an 'Eora interlocutor with the British in Australia and the United Kingdom'.
2. A person may be linked to a record in the [Indigenous Australia](https://ia.anu.edu.au/) database ([P9246](https://www.wikidata.org/wiki/Property:P9246)).

We eventually abandoned the first marker, because it presented two difficult problems. First, non-Indigenous Australians such as [Judith Wright](https://www.wikidata.org/w/index.php?title=Q469885&oldid=1989984400) may contain keywords such as 'Indigenous' in their descriptions, confusing the filter. Second, Australia is home to hundreds of Indigenous peoples, whose names have been spelled in numerous ways since colonisation. A careful search for indigenous 
