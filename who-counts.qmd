...
ggplot(data_page_health, aes(value, fill = gender_group))+
...
@fig-gender-page-health reveals a stark contrast between readers and editors of the encylopaedia. **TODO: Explain new chart.**
...
This study reveals the importance of examining Wikipedia on a national level
