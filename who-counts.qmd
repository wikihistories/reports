...
The distinction between 'settler' and 'indigenous' Australian pervades Wikipedia. Like gender, racial or ethnic origin is marked in a lopsided manner by the encyclopaedia (see @mandiberg_wikipedias_2023). There is no explicit category for 'settler Australian' or 'white Australian'. Categories such as [Category:Immigrants to Australia](https://en.wikipedia.org/wiki/Category:Immigrants_to_Australia) and [Category:Australian people of European Descent](https://en.wikipedia.org/wiki/Category:Australian_people_of_European_descent) are applied in a haphazard way to indicate the 'settler' status of a minority of Australians. [Tony Abbott](https://en.wikipedia.org/w/index.php?title=Tony_Abbott&oldid=1178396384), for example, while born in London, is categorised neither as 'of European descent' nor as an 'immigrant' at the time of writing. By contrast, editors are instructed to categorise Aboriginal and Torres Strait Islander Australians as precisely as possible (@fig-template-catdiffuse-indig-aus).
...
Wikipedia carefully categorises Indigenous and Torres Strait Islander people  Instead, Wikipedians consider indigeneity to be an aspect of 'ethnic or national origin' (@fig-ethnic-categorisation-graph)
