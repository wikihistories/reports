...
australians$nodes %>% 
  ...
  transmute(
    ...
    `Non-biography (prop)` = non_bio_prop
  ) %>% 
...
biography_growth %>% 
  ...
  facet_wrap(vars(page_type), nrow = 2, scales = "free_y") +
