...
We combine our two datasets into a single larger dataset of `r full_dataset %>% filter(is_human, on_english_wikipedia) %>% nrow() %>% prettyNum(",")` articles. To enable analysis of these articles, we then enrich them with three kinds of metadata:
